<?php
  ...
  define('baseurl', 'http://2.2.2.2/radiusmanager');	// base URL of your RM system

  // system definitions

  define('admin_user', 'admin');				// name of superuser
  define('def_syslang', 'Arabic');				// default system language (fallback)
  ...
  define('hotspot_ip', 'http://2.2.2.2');			// URL of Hotspot login page
  ...
  define('card_pin_len', 4);					// default PIN length (4-16)
  define('card_psw_len', 2);					// default card password length (0-8)
  define('ias_pin_length', 8);					// IAS PIN code length
  define('ias_psw_length', 4);					// IAS and mobile number registration password length
  define('rndchars', '123456789ABCDEFGHIJKLMNOPQRSTVWXYZ');	// default random characters
  define('rndcardpin', '123456789');				// random characters in card PIN codes
  define('rndcardpass', '123456789');				// random characters in card passwords
  define('rndstring_len', 4);					// length of verification code (1-10)
  define('max_smsnum', 2);					// max. number of card verification SMS
  ...
  define('session_timeout', 120);				// PHP session timeout in minutes
  ...
  define('newpsw_len', 6);					// length of generated password
  ...
  define('smtp_user', 'mrjohnmohamed25@gmail.com');		// SMTP user name
  define('smtp_psw', 'mrjohnmohamed');				// SMTP password
  define('mail_from', 'mrjohnmohamed25@gmail.com');	        // sender address
  define('mail_fromname', 'speed');			        // sender name
  define('mail_newuser', 'mrjohnmohamed25@gmail.com');		// self registered new user notification
  ...
  define('min_psw_len', 0);					// minimal regular password length
  ...
  define('username_x_pos', 40);					// username x position on classic prepaid card
  define('username_y_pos', 33);					// username y position on classic prepaid card
  define('pdfprint_expiration', false);				// PDF print valid till text
  define('pdfprint_price', true);				// PDF print price
 
 
  define('pdfprint_Total downloads in MB', true);				// PDF print Total downloads in MB
  define('Total downloads in MB_x_pos', 70);					// Total downloads in MB x position on card
  define('Total downloads in MB_y_pos', 10);					// Total downloads in MB y position on card
  ...
  define('psw_x_pos', 37);					// password x position on classic prepaid card
  define('psw_y_pos', 40);					// password y position on classic prepaid card
  define('pin_x_pos', 28);					// PIN x position on refill card
  define('pin_y_pos', 41);					// PIN y position on refill card
  define('price_x_pos', 87);					// price x position on card
  define('price_y_pos', 20);					// price y position on card
  define('date_x_pos', 72);					// valid till x position on card
  define('date_y_pos', 43);					// valid till y position on card
  define('serial_x_pos', 27);					// serial x position on card
  define('serial_y_pos', 60);					// serial y position on card
  define('series_x_pos', 64);					// series x position on card
  define('series_y_pos', 60);					// series y position on card
  define('descr_x_pos', 15);					// description x position on card
  define('descr_y_pos', 52);					// description y position on card
  ...
  define('price_font_size', 18);				// price font size
  define('price_font_color', 'ffffff');				// price font color
  define('serial_font_type', 'Times');				// serial font typeface
  define('serial_font_size', 1);				// serial font size
  define('serial_font_color', '000000');			// serial font color
  define('series_font_type', 'Times');				// series font typeface
  define('series_font_size', 1);				// series font size
  define('series_font_color', '000000');			// series font color
  define('srvname_font_type', 'Times');				// serial font typeface
  define('srvname_font_size', 1);				// serial font size
  define('srvname_font_color', '000000');			// serial font color
  ...
  $stateslist = array(array("", ""),
                      array("-- EGYPT ALEXANDRIA --", ""),
                      array("-- EGYPT kena --", ""),
                      array("-- SAUDI ARABIA RYad --", ""),
                      array("-- SAUDI ARABIA GADA --", ""),
  		      );
?>